...
class VideoComparison {
    ...
    drawLoop() {
        ...
        function drawFrame() {
            ...
            // Draw circle
            context.arc(currX, arrowPosY, arrowLength * 0.5, 0, Math.PI * 2, false);
            ...
            context.strokeText('RegNeRF + DP kernel', 10, canvasHeight - 5)
            context.fillText('RegNeRF + DP kernel', 10, canvasHeight - 5);

            context.textAlign = "right";
            context.strokeText('Sparse-DeRF (Ours)', canvasWidth - 10, canvasHeight - 5)
            context.fillText('Sparse-DeRF (Ours)', canvasWidth - 10, canvasHeight - 5);
